...
\section*{Total Hours to Complete}
Total number of hours: [Insert Hours]
...
\begin{figure}[H]
    \centering
    % \includegraphics[width=0.7\textwidth]{figures/A1_ESD.png}
...
\begin{figure}[H]
    \centering
    % \includegraphics[width=0.7\textwidth]{figures/A3_PSD_2PAM.png}
...
\begin{figure}[H]
    \centering
    % \includegraphics[width=0.7\textwidth]{figures/A4_PSD_4PAM.png}
...
\begin{figure}[H]
    \centering
    % \includegraphics[width=0.7\textwidth]{figures/A5_PSD_Tprime.png}
...
\begin{figure}[H]
    \centering
    % \includegraphics[width=0.7\textwidth]{figures/B1_Realizations.png}
